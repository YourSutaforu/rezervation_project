...
/* ===== ZPRACOVÁNÍ FORM ===== */
if (isset($_POST['big_room_res_Submit'])) {
...
<head>
    ...
    <title>rezervace mistnosti 80^2</title>
...
<div class="calendar-page">
    ...
    <div class="calendar-container">
        <form action="./big_room_calendar.php"
              method="post"
              id="room_form"
            ...
            <input type="hidden" name="room_name" value="velka mistnost 80^2">

            <br><br>
            <input type="submit" name="big_room_res_Submit">
        </form>
